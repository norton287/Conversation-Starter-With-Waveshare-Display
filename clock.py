...
# Extract year, month, day, hour, minute, and second from adjusted time
year, month, day, wd, hour, minute, second, _ = rtc.datetime()
...
def draw_clock():
    ...
    LCD.fill_rect(10, 50, (hour * 8 + 15), 42, color(255,255,0))
    LCD.fill_rect(10, 105, (minute * 3 + 50), 42, color(250, 194, 19))
    LCD.fill_rect(10, 165, (second * 3 + 20), 42, color(155, 155, 93))

    prnt_st(hr, 20, 59, 3, 0,0,0)
    prnt_st(min, 20, 114, 3, 255,255,255)
    prnt_st(sec, 20, 174, 3, 255,255,255)
